 ...
 * @extends Component
 */
export class CustomerMovieRow extends Component {
    ...
    return (
        <div id="movie-row-div" className="container-fluid">
            ...
            <div className="movie-row-buttons-div">
              <Link to={"/customermoviedetails/"+this.state.id} onClick={this.handleClick}>
...
CustomerMovieRow.propTypes = {
  movie: PropTypes.object.isRequired,
};

export default CustomerMovieRow;
